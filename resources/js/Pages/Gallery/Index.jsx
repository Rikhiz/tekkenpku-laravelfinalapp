    ...
    return (
        <AppLayout>
            <div className="min-h-[75vh] flex flex-col items-center justify-center text-center px-6 py-16">
                ...
                <a
                    href="https://drive.google.com/drive/folders/1mYk7qyRkoAz8qnZhtZCuhI59yRUsYEf4"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="max-w-md w-full p-10 bg-gradient-to-br from-[#1a1a1a]/90 to-[#69747C]/20 backdrop-blur-xl 
                ...
                >
                    ...
                    <p className="text-[#F2F2F2] text-lg leading-relaxed">
                        🚧 Coming Soon... <br />
                        Bisa Langsung Dilihat di Googgle Drive 
                        <br />
                        Klik Saya!
                    </p>
                </a>
