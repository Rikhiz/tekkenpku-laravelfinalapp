...
import { Plus, Edit3, Trash2, Calendar, Users, Award, ExternalLink, X } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {tournaments.map((tournament) => (
                        <div key={tournament.tourid} className="bg-gray-800 rounded-2xl shadow-lg border border-gray-700 overflow-hidden hover:border-gray-600 transition-colors">
                            {/* Tournament Image */}
                            ...
                            <div className="p-4">
                                ...
                                <div className="space-y-2 mb-4">
                                    <div className="flex items-center text-sm text-gray-400">
                                        ...
                                        <span>Dibuat oleh: {tournament.creator?.name}</span>
                                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    {errors.created_by && <p className="mt-1 text-sm text-red-400">{errors.created_by}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-white"
                                    />
                                    {errors.max_pemain && <p className="mt-1 text-sm text-red-400">{errors.max_pemain}</p>}
                                </div>
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    />
                                    {errors.desc && <p className="mt-1 text-sm text-red-400">{errors.desc}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.url_yt && <p className="mt-1 text-sm text-red-400">{errors.url_yt}</p>}
                                </div>
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.url_startgg && <p className="mt-1 text-sm text-red-400">{errors.url_startgg}</p>}
                                </div>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <div className="mt-2">
                                    <p className="text-sm text-gray-400">
                                        Apakah Anda yakin ingin menghapus tournament "{tournamentToDelete?.name}"? 
