      ...
      <div className="space-y-6">
        ...
        <div className="bg-gray-800 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-700 hover:bg-gray-600 text-white p-4 rounded-lg transition-colors cursor-pointer">
              <Trophy size={20} className="mb-2 text-yellow-500" />
              <h3 className="font-semibold mb-1">Create Tournament</h3>
              <p className="text-sm text-gray-400">Set up a new tournament</p>
            </div>
            <div className="bg-gray-700 hover:bg-gray-600 text-white p-4 rounded-lg transition-colors cursor-pointer">
              <Users size={20} className="mb-2 text-blue-500" />
              <h3 className="font-semibold mb-1">Manage Users</h3>
              <p className="text-sm text-gray-400">View and edit user accounts</p>
            </div>
            <div className="bg-gray-700 hover:bg-gray-600 text-white p-4 rounded-lg transition-colors cursor-pointer">
              <Image size={20} className="mb-2 text-purple-500" />
              <h3 className="font-semibold mb-1">Gallery Management</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
              ...
              <span className="text-blue-400 font-semibold">
                {stats.users + stats.tournaments + stats.galleries + stats.relasi}
              </span>
            </div>
          </div>
        </div>
